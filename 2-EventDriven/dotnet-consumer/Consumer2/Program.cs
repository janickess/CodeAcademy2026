...
await channel.QueueDeclareAsync(queue: "consumer-2", durable: true, exclusive: false, autoDelete: false, arguments: null);
await channel.QueueBindAsync(queue: "consumer-2", exchange: "testtt", routingKey: string.Empty, arguments: null);
...
await channel.BasicConsumeAsync(queue: "consumer-2", autoAck: false, consumerTag: "", noLocal: false, exclusive: false, arguments: null, consumer: consumer);
